<div class="mbt-au-field-container">
    ...
    <?php if($user_ID > 0) { ?>
        ...
        <div class="mbt-au-field avatar-field-sec">
            ...
            <img class="sec-overlay-spinner" src="<?php echo MBT_AU_PLUGIN_URL; ?>/assets/images/spinner.gif">
            <div class="sec-overlay"></div>

            <div class="mbt-au-field avatar-field <?php echo $af_class; ?>">
                <img id="mbt_au_avatar" src="<?php echo $avatar_url; ?>">
            </div>
        ...
        <div class="mbt-au-field preview-field">
            ...
            <img class="ajax-overlay-spinner" src="<?php echo MBT_AU_PLUGIN_URL; ?>/assets/images/spinner.gif">
